...
export function getPortalChartTheme(mode: PortalChartMode): PortalChartTheme {
  if (mode === "dark") {
    return {
      mode,
      card: "min-w-0 overflow-hidden rounded-2xl border-[4px] border-white/25 bg-[#141414] p-4 shadow-[0_8px_24px_rgba(0,0,0,0.45)] sm:p-5 md:p-6",
      title: "text-white",
      muted: "text-white/45",
      body: "text-white/90",
      track: "border-2 border-white/15 bg-white/[0.06]",
      trackBorder: "border-white/15",
      pieStroke: "#141414",
      grid: "rgba(255,255,255,0.08)",
      tick: "#f4f4f5",
      tickMuted: "#a3a3a3",
      tooltip: "rounded-xl border-2 border-white/20 bg-[#1a1a1a] px-3.5 py-2.5 shadow-xl",
  ...
  return {
    mode,
    card: "min-w-0 overflow-hidden rounded-2xl border-[5px] border-[#a8a8a8] bg-[#e9e9e9] p-4 shadow-[0_8px_24px_rgba(0,0,0,0.25)] sm:p-5 md:p-6",
    title: "text-[#0a0a0a]",
    muted: "text-[#555]",
    body: "text-[#1a1a1a]",
    track: "border-[3px] border-[#c0c0c0] bg-[#d8d8d8]",
    trackBorder: "border-[#c0c0c0]",
    pieStroke: "#e9e9e9",
    grid: "rgba(0,0,0,0.08)",
    tick: "#1a1a1a",
    tickMuted: "#666",
    tooltip: "rounded-xl border-[3px] border-[#b8b8b8] bg-white px-3.5 py-2.5 shadow-xl",
    tooltipTitle: "text-[#0a0a0a]",
    tooltipBody: "text-[#555]",
    hairline: "border-[#c0c0c0]",
    toggleBtn:
